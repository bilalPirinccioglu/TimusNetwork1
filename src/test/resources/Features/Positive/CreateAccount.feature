...
Feature: Yeni Hesap Oluşturma Kontrolleri

  Scenario Outline: Yeni hesap oluşturma başarılı durum kontrolü
    ...
    Examples:
      ...
      | Testname   | testLastName | test4@test.com | Turkey | test         | Timus2020** | Timus2020**       |
